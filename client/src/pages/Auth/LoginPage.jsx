...
import { login, socialLogin, clearError } from '../../features/auth/authSlice';
  ...
  const handleAppleSignIn = async () => {
    ...
    try {
      ...
      if (socialLogin.fulfilled.match(result)) {
        ...
        toast.error(result.payload || 'Apple sign-in failed');
      }
    } catch (err) {
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <p className="text-center text-gray-600">
            ...
            <Link to="/register" className="text-[#FF385C] hover:text-[#E31C5F] font-medium">
              Sign up
            </Link>
          </p>
        </form>
